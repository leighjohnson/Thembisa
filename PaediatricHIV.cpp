...
int _tmain()
{
	...
	cout<<"AliveTotal[5]: "<<AliveTotal[5]<<endl;
	cout<<"EligibleTotal[3]: "<<EligibleTotal[3]<<endl;
	cout<<"NonAIDSdeathsTotal[7]: "<<NonAIDSdeathsTotal[7]<<endl;
	cout<<"AIDSdeathsTotal[0]: "<<AIDSdeathsTotal[0]<<endl;
	cout<<"DeathsTotal[12]: "<<DeathsTotal[12]<<endl;
	cout<<"StartingARTtotal[4]: "<<StartingARTtotal[4]<<endl;
	cout<<"CentralMort[1]: "<<CentralMort[1]<<endl;
	cout<<"CentralMort[2]: "<<CentralMort[2]<<endl;
	cout<<"CentralMort[3]: "<<CentralMort[3]<<endl;
	cout<<"CentralMort[4]: "<<CentralMort[4]<<endl;
	cout<<"CentralMort[5]: "<<CentralMort[5]<<endl;
	cout<<"CentralMort[6]: "<<CentralMort[6]<<endl;
	cout<<"CentralMort[7]: "<<CentralMort[7]<<endl;
	cout<<"NewHIVatBirthTotal: "<<NewHIVatBirthTotal<<endl;
	cout<<"NewHIVafterBirthTotal: "<<NewHIVafterBirthTotal<<endl;
	cout<<"ARTinitiationStore: "<<ARTinitiationStore<<endl;*/
...
void runIMIS()
{
	...
	for(i=0; i<IMISsteps; i++){
		...
		cout<<"Finished IMIS step "<<i+1<<endl;
	}
